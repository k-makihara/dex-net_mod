...
# install pip deps
pip install numpy scipy scikit-learn scikit-image opencv-python-headless pyassimp tensorflow==1.15.0 h5py matplotlib catkin_pkg multiprocess dill cvxopt ipython pillow pyhull setproctitle trimesh
